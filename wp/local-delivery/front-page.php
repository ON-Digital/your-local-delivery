<?php get_header(); ?>
  ...
  <section class="s-how-to container mt-5">
    <div class="row">
      ...
      <div class="col-8 ml-auto mr-auto col-md-4 grid-wrp justify-items-center mt-2">
        ...
        <h3 class="text-center mt-3 text-primary" id="ldv_how_work_01">
          <?php
        ...
        <p class="text-center" id="how_work_01_cnt">
          <?php
      ...
      <div class="col-8 ml-auto mr-auto col-md-4 grid-wrp justify-items-center mt-2">
        ...
        <h3 class="text-center mt-3 text-primary" id="how_work_02">
          <?php
        ...
        <p class="text-center" id="how_work_02_cnt">
          <?php
      ...
      <div class="col-8 ml-auto mr-auto col-md-4 grid-wrp justify-items-center mt-2">
        ...
        <h3 class="text-center mt-3 text-primary" id="how_work_03">
          <?php
        ...
        <p class="text-center" id="how_work_03_cnt">
          <?php
  ...
  <section class="s-our-courier background-no-repeat-cover container-mg-t bg-dark-layer pb-5">
    <div class="container pt-5">
      <h2 class="text-center text-white w-100 font-semibold" id="ldv_service_price">
        <?php
      ...
      <div class="row">
        <div class="col-8 mr-auto mr-md-4 col-md-3 ml-auto mt-2 text-center">
          <div class="border border-white border-wide mt-3 pb-4">
            <h3 class="text-center mt-4 text-white s-our-courier__subti font-semibold" id="service_price_tit01">
            ...
            <span class="d-block text-primary courier-amount" id="service_price_number">
        ...
        <div class="col-8 ml-auto ml-md-4 col-md-3 mr-auto mt-2 text-center">
          <div class="border border-wide border-white mt-3 pb-4">
            <h3 class="text-center mt-4 text-white s-our-courier__subti font-semibold" id="service_price_tit02">
              <?php
            ...
            <span class="d-block text-primary courier-amount" id="service_price_number02">
  ...
  <section class="s-services container-fluid">
    <div class="row">
      <header class="mt-5 pt-3 w-100">
        <h2 class="text-center w-100" id="ldv_service_offer_tit">
          <?php
        ...
        <p class="text-center mt-4 mb-5 pb-4 pr-5 pl-5" id="ldv_service_excerpt">
          <?php
    ...
    <form action="<?php echo esc_url( $_SERVER['REQUEST_URI'] ); ?>" method="post" class="row no-gutters mt-3">
      ...
      <div class="col-10 col-md-5 ml-auto mr-auto mr-md-0 d-table mb-3">
        <label class="d-table-cell">
          <input type="text" class="form-control form-control-lg form-control--m rounded-0" placeholder="First and last name" name="ldv_name_inp" id="ldv_name_inp" required>
        </label>
      </div>

      <div class="col-10 col-md-5 ml-auto ml-md-5 mr-auto d-table mb-3">
        <label class="d-table-cell">
          <input type="text" class="form-control form-control-lg form-control--m rounded-0" placeholder="Email" id="ldv_email_inp" name="ldv_email_inp" required>
        </label>
      </div>

      <div class="col-10 col-md-5 ml-auto mr-auto mr-md-0 d-table mb-3">
        <label class="d-table-cell">
          <input type="text" class="form-control form-control-lg form-control--m rounded-0 mt-md-3" placeholder="Phone Number" id="ldv_phone_inp" name="ldv_phone_inp" required>
        </label>
      </div>

      <div class="col-10 col-md-5 ml-auto ml-md-5 mr-auto d-table mb-3">
        <label class="d-table-cell">
          <input type="text" class="form-control form-control-lg form-control--m rounded-0 mt-md-3" placeholder="Company" id="ldv_company_inp" name="ldv_company_inp" required>
        </label>
      </div>
      ...
      <div class="col-10 col-md-5 ml-auto mr-auto text-center text-md-left">
        <?php
          $index_array = isset( $_POST['ldv_frecquency_inp'] ) ? $_POST['ldv_frecquency_inp'] : 0;
        ?>

        <p class="mt-4">
          <label class="ml-2 input-480media">
            <input type="radio" id="ldv_once_frecquency" name="ldv_frecquency_inp" value="1" <?php echo checked( $index_array, 1 ); ?> required>
          ...
          <label class="ml-2 ml-md-4 input-480media">
            <input type="radio" id="ldv_1_week_frecquency" name="ldv_frecquency_inp" value="2" <?php echo checked( $index_array, 2 ); ?> required>
        ...
        <p class="">
          <label>
            <input type="radio" id="ldv_2_week_frecquency" name="ldv_frecquency_inp" value="3" <?php echo checked( $index_array, 3 ); ?> required>
          ...
          <label>
            <input type="radio" class="ml-2 ml-md-5" id="ldv_10_week_frecquency" name="ldv_frecquency_inp" value="4" <?php echo checked( $index_array, 4 ); ?> required>
            <span class="ml-md-1">
      ...
      <div class="col-10 d-table ml-auto mr-auto mt-4 d-table">
        <textarea rows="4" cols="68" class="form-control--m d-table-cell c-textarea-comments w-100 pl-3 pt-2" placeholder="Tell us about your delivery needs" id="ldv_message_inp" name="ldv_message_inp" required></textarea>
  ...
  // if data is submitted we call the filter callback that handle that data, send the mail and display a message that indicate the status of the operation
   ...
   {
     $name_user = isset( $_POST['ldv_name_inp'] ) ? $_POST['ldv_name_inp'] : '';
     $email_user = isset( $_POST['ldv_email_inp'] ) ? $_POST['ldv_email_inp'] : '';
     $number_user = isset( $_POST['ldv_phone_inp'] ) ? $_POST['ldv_phone_inp'] : '';
     $company = isset( $_POST['ldv_company_inp'] ) ? $_POST['ldv_company_inp'] : '';
     $frecquency_deliveries = isset( $_POST['ldv_frecquency_inp'] ) ? $_POST['ldv_frecquency_inp'] : '';
     $message = isset( $_POST['ldv_message_inp'] ) ? $_POST['ldv_message_inp'] : '';
